...
同一 HIL 数据还保存了从零训练的 ACT checkpoint，可用于明天的严格对照。
...
按 [`../docs/EXPERIMENT_PROTOCOL.md`](../docs/EXPERIMENT_PROTOCOL.md) 比较 base20k、scratch10k 和 finetune10k，先做 36 次配对筛查，再对最终模型做 45 次颜色 × 布局验收。只有逐 trial 数据和置信区间完成后，才冻结最终成功率和课程学习因果结论。
