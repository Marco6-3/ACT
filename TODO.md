...
- [ ] 当前 no-hold runtime 下分别运行 E3-Orbbec M=5、M=10、M=30 各 20 次；旧 5 次只作 pilot，不并入正式统计
- [ ] 阶段 1 选出最佳 M 后固定它，以相同布局、成功定义和光照协议运行 E1-D435i1、E2-D435i2 各 20 次；E3 复用阶段 1 对应结果
- [ ] E4/Mix-1 在 D435i1、D435i2、Orbbec 三个部署视角下各 20 次；与同一相机上的 E1/E2/E3 基线分别比较
- [ ] E3 checkpoint 换 D435i1/D435i2 各做 5 次 OOD smoke；有有效闭合/抓取行为再补到各 20 次
